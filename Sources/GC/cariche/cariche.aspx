<%@ Page Language="C#" 
         ...
         Inherits="cariche_cariche" 
         Title="Persona > Cariche" %>
			...
			<asp:GridView ID="GridView1" 
			    ...
			    <Columns>
				    ...
				    <asp:TemplateField HeaderText="Priorità Attuale" SortExpression="priorita_attuale">
				        <ItemTemplate>                            
<%--					        <asp:LinkButton ID="priorita_attuale" 
					                        runat="server" 
					                        CausesValidation="False" 
		...
		<asp:Panel ID="PanelDetails" 
		           ...
		           Width="500" 
		           ScrollBars="Vertical" 
		           Style="padding: 10px; display: none; max-height: 550px;">
		    <div align="center">
			<br />
			<h3>
			    CARICHE
			...
			<ContentTemplate>
			    <asp:DetailsView ID="DetailsView1" 
				    ...
				    <Fields>
				        ...
				        <asp:TemplateField HeaderText="Circoscrizione" SortExpression="circoscrizione">
					    <ItemTemplate>
					        <asp:Label ID="LabelCircoscrizione" runat="server" Text='<%# Bind("circoscrizione") %>'></asp:Label>
					    </ItemTemplate>
					    <EditItemTemplate>
					        <asp:TextBox ID="TextBoxCircoscrizione" runat="server" Text='<%# Bind("circoscrizione") %>'
				        ...
				        <asp:TemplateField HeaderText="Data Elezione" SortExpression="data_elezione">
					    <ItemTemplate>
					        <asp:Label ID="LabelDataElezione" runat="server" Text='<%# Bind("data_elezione", "{0:dd/MM/yyyy}") %>'></asp:Label>
					    </ItemTemplate>
					    <EditItemTemplate>
					        <asp:TextBox ID="TextBoxDataElezione" runat="server" Text='<%# Bind("data_elezione", "{0:dd/MM/yyyy}") %>'></asp:TextBox>
					        <img alt="calendar" src="../img/calendar_month.png" id="ImageDataElezione" runat="server" />
					        <cc1:CalendarExtender ID="CalendarExtenderDataElezione" runat="server" TargetControlID="TextBoxDataElezione"
						    PopupButtonID="ImageDataElezione">
					        </cc1:CalendarExtender>
					        <asp:RegularExpressionValidator ID="RegularExpressionDataElezione" ControlToValidate="TextBoxDataElezione"
					    ...
					    <ItemTemplate>
					        <asp:Label ID="LabelLista" runat="server" Text='<%# Bind("lista") %>'></asp:Label>
					    </ItemTemplate>
					    <EditItemTemplate>
					        <asp:TextBox ID="TextBoxLista" runat="server" Text='<%# Bind("lista") %>' MaxLength="50"></asp:TextBox>
					    </EditItemTemplate>
					    <InsertItemTemplate>
					        <asp:TextBox ID="TextBoxLista" runat="server" Text='<%# Bind("lista") %>' MaxLength="50"></asp:TextBox>
					    </InsertItemTemplate>
				        </asp:TemplateField>
				        <asp:TemplateField HeaderText="Maggioranza" SortExpression="maggioranza">
					    <ItemTemplate>
					        <asp:Label ID="LabelMaggioranza" runat="server" Text='<%# Bind("maggioranza") %>'></asp:Label>
					    </ItemTemplate>
					    <EditItemTemplate>
					        <asp:TextBox ID="TextBoxMaggioranza" runat="server" Text='<%# Bind("maggioranza") %>'
						    MaxLength="50"></asp:TextBox>
					    </EditItemTemplate>
					    <InsertItemTemplate>
					        <asp:TextBox ID="TextBoxMaggioranza" runat="server" Text='<%# Bind("maggioranza") %>'
				        ...
				        <asp:TemplateField HeaderText="Voti" SortExpression="voti">
					    <ItemTemplate>
					        <asp:Label ID="LabelVoti" runat="server" Text='<%# Bind("voti") %>'></asp:Label>
					    </ItemTemplate>
					    <EditItemTemplate>
					        <asp:TextBox ID="TextBoxVoti" runat="server" Text='<%# Bind("voti") %>'></asp:TextBox>
					        <asp:RegularExpressionValidator ID="RegularExpressionVoti" ControlToValidate="TextBoxVoti"
				        ...
				        <asp:CheckBoxField DataField="neoeletto" HeaderText="Neoeletto?" SortExpression="neoeletto" />
				        --%>
			...
			<ContentTemplate>
				...
				Esporta <img src="../img/page_white_excel.png" alt="" align="top" /><br />
				</asp:LinkButton>
				<asp:LinkButton ID="LinkButtonPdfDetails" runat="server" OnClick="LinkButtonPdfDetails_Click">
				Esporta <img src="../img/page_white_acrobat.png" alt="" align="top" />
				</asp:LinkButton>
			    </div>
			</ContentTemplate>
			<Triggers>
