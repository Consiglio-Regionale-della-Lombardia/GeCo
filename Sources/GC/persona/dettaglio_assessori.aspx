<%@ Page Language="C#" 
         ...
         CodeFile="dettaglio_assessori.aspx.cs" 
         Inherits="dettaglio_assessori" 
         Title="Assessori > Anagrafica" %>
	    ...
	    <div id="tab_content">
	        <div id="tab_content_content">
				...
				<asp:Panel ID="PanelVediChiusure" 
                    ...
                    <div align="center">
                        ...
                        <asp:Label Text="Attenzione: prima di poter vedere lo storico è necessario chiudere questo assessore" runat="server" ID="avvisoNessunoStorico" ForeColor="Red" Visible="false"></asp:Label>
		    ...
		    <tr>
			    <td class="singleborder" valign="top" width="75%">
			        <asp:DetailsView Width="100%" 
				        ...
				        <Fields>					
				            ...
				            <asp:TemplateField HeaderText="Cognome" SortExpression="cognome">
					            ...
					            <InsertItemTemplate>
					                <asp:TextBox ID="TextBoxCognome" MaxLength="50" runat="server" Text='<%# Bind("cognome") %>'>
					                </asp:TextBox>
				            ...
				            <asp:TemplateField HeaderText="Sesso" SortExpression="sesso">
					            <ItemTemplate>
					                <asp:Label ID="LabelSesso" runat="server" Text='<%# Bind("sesso") %>'></asp:Label>
					            </ItemTemplate>
					            
					            <EditItemTemplate>
					                <asp:RadioButtonList runat="Server" ID="RadioButtonList1" SelectedValue='<%# Bind("sesso") %>'>
					            ...
					            <InsertItemTemplate>
					                <asp:RadioButtonList runat="Server" ID="RadioButtonList2" SelectedValue='<%# Bind("sesso") %>'>
						            <asp:ListItem Value="M" Text="M" Selected="True" />
						            <asp:ListItem Value="F" Text="F" />
					                </asp:RadioButtonList>
					            </InsertItemTemplate>
				            ...
				            <asp:TemplateField HeaderText="Nato/a il" SortExpression="data_nascita">
					            ...
					            <EditItemTemplate>
					                ...
					                <img alt="calendar" src="../img/calendar_month.png" id="ImageDataNascitaEdit" runat="server" />
					                ...
					                <asp:RequiredFieldValidator ID="RequiredFieldValidatorNascita" 
					            ...
					            <InsertItemTemplate>
					                ...
					                <img alt="calendar" src="../img/calendar_month.png" id="ImageDataNascitaInsert" runat="server" />
				            ...
				            <asp:TemplateField HeaderText="Nato/a a">
					            ...
					            <InsertItemTemplate>
					                ...
					                <cc1:AutoCompleteExtender ID="AutoCompleteExtenderComuneNascitaInsert" runat="server"
						            EnableCaching="True" 
					            ...
					            <EditItemTemplate>
									<asp:HiddenField ID="TextBoxComuneNascitaId" runat="server" Value='<%# Bind("id_comune") %>'></asp:HiddenField>
					                <asp:TextBox ID="TextBoxComuneNascita" runat="server" Text='<%# Eval("nome_comune") %>'></asp:TextBox>
					                
					                <asp:RequiredFieldValidator ID="RequiredFieldValidatorComune" runat="server" ControlToValidate="TextBoxComuneNascita"
						            ErrorMessage="Campo obbligatorio." Display="Dynamic" >
						            </asp:RequiredFieldValidator>
						            
					                <asp:RegularExpressionValidator ID="RegularExpressionValidatorComune" runat="server"
						            ControlToValidate="TextBoxComuneNascita" ErrorMessage="Formato non valido."
						            Display="Dynamic" ValidationExpression="^[A-Za-z'\*\s\-]+\([A-Za-z]{2}\)$" >
						            </asp:RegularExpressionValidator>
						            
					                <div id="DivComuneNascitaEdit">
					                </div>
					                
					                <cc1:AutoCompleteExtender ID="AutoCompleteExtenderComuneNascitaEdit" runat="server"
						            EnableCaching="True" TargetControlID="TextBoxComuneNascita" ServicePath="~/ricerca_comuni.asmx"
						            ServiceMethod="RicercaComuni" MinimumPrefixLength="1" CompletionInterval="0"
						            CompletionListElementID="DivComuneNascitaEdit" CompletionSetCount="15" OnClientItemSelected="autoCompleteComuneNascitaSelected">
						            <Animations>
						                <OnShow>
							            <Sequence>
							                <OpacityAction Opacity='0' />
				            ...
				            <asp:TemplateField HeaderText="Codice Fiscale" SortExpression="codice_fiscale">
					            <ItemTemplate>
					                <asp:Label ID="LabelCF" runat="server" Text='<%# Bind("codice_fiscale") %>'></asp:Label>
					            </ItemTemplate>
    						    
					            <EditItemTemplate>
					                <asp:TextBox ID="TextBoxCF" MaxLength="16" runat="server" Text='<%# Bind("codice_fiscale") %>'></asp:TextBox>
				            ...
				            <asp:TemplateField HeaderText="Numero Tessera" SortExpression="numero_tessera">
					            <EditItemTemplate>
					                <asp:TextBox ID="TextBoxNT" MaxLength="20" runat="server" Text='<%# Bind("numero_tessera") %>'></asp:TextBox>					            
					            </EditItemTemplate>
    						    
					            <InsertItemTemplate>
					                <asp:TextBox ID="TextBoxNT" MaxLength="20" runat="server" Text='<%# Bind("numero_tessera") %>'></asp:TextBox>					            
					                <asp:RegularExpressionValidator ID="RegularExpressionValidatorTessera" ControlToValidate="TextBoxNT"
						            runat="server" Display="Dynamic" ErrorMessage="Solo cifre ammesse." ValidationExpression="^[0-9]+$">
					                </asp:RegularExpressionValidator>
					            </InsertItemTemplate>
    						    
					            <ItemTemplate>
					                <asp:Label ID="LabelNT" runat="server" Text='<%# Bind("numero_tessera") %>'></asp:Label>
					            </ItemTemplate>
				            </asp:TemplateField>
    					    
				            <asp:TemplateField HeaderText="Professione" SortExpression="professione">
					            <EditItemTemplate>
					                <asp:TextBox ID="TextBoxProf" MaxLength="50" runat="server" Text='<%# Bind("professione") %>'></asp:TextBox>
					            </EditItemTemplate>
					            ...
					            <ItemTemplate>
					                <asp:Label ID="LabelProf" runat="server" Text='<%# Bind("professione") %>'></asp:Label>
					            </ItemTemplate>
				            </asp:TemplateField>
					    ...
					    <td>
						    ...
						    <ContentTemplate>
						        ...
						        <asp:SqlDataSource ID="SqlDataSourceResidenzaAttuale" 
							                       ...
							                       SelectCommand="SELECT jj.indirizzo_residenza + ', ' +  cc.comune + ' (' + cc.provincia + ')' AS indirizzo
				    ...
				    <table width="100%" cellpadding="10" class="singleborder">
					    ...
					    <td>
						    ...
						    <ContentTemplate>
						        <asp:DataList ID="DataListEmail" runat="server" 
							    DataSourceID="SqlDataSourceListaEmail">
							    <HeaderTemplate>
							        <b>Email:</b>
							    </HeaderTemplate>
							    <ItemTemplate>								    
						        ...
						        <asp:DataList ID="DataListRecapiti" runat="server" 
							    DataSourceID="SqlDataSourceListaRecapiti">
							    <HeaderTemplate>
							        <b>Recapiti:</b>
							    </HeaderTemplate>
							    <ItemTemplate>
							        ...
							        <b><asp:Label ID="LabelRecapito" runat="server" Text='<%# Eval("recapito") %>' /></b>
							    </ItemTemplate>
						        </asp:DataList>
				    ...
				    <table width="100%" cellpadding="10" class="singleborder">
					    ...
					    <% if (role <= 2) { %>
					    <td width="250">
					        <asp:Button ID="ButtonTitoliStudio" runat="server" Text="Gestisci titoli di studio..." Width="250px" />
					    </td>
					    <% } %>
				        </tr>
				    </table>
			    ...
			    <td align="center" valign="top">
			        <div align="center">
				    <img src="<%= photoName %>?idFoto=<%= DateTime.Now %>" align="middle" height="150"
				        width="150" alt="Foto" />
			        </div>
			        ...
			        <asp:Label ID="LabelSospeso" 
			                   runat="server" 
			                   Text=" L'assessore è attualmente sospeso."
				               Font-Bold="true" 
				               ForeColor="Red" 
				               Visible="false">
				    </asp:Label>
			        ...
			        <asp:Label ID="LabelSostituito" 
			                   runat="server" 
			                   Text=" L'assessore è attualmente sostituito da"
				               Font-Bold="true"
				               ForeColor="Red" 
				               Visible="false">
				    </asp:Label>
			        ...
			        <asp:Label ID="LabelSostituente" 
			                   runat="server" 
			                   Text=" L'assessore è attualmente sostituente di "
				               Font-Bold="true"
				               ForeColor="Red" 
				               Visible="false">
				    </asp:Label>--%>
			        ...
			        <asp:Panel ID="PanelResidenze" 
				        ...
				        <div align="center">
				            <br />
				            <h3>
					        GESTIONE RESIDENZE</h3>
				            <br />
				        </div>
					    
				        <asp:UpdatePanel ID="UpdatePanelResidenze" runat="server">
				            <ContentTemplate>
					        <asp:ListView ID="ListViewResidenze" 
					                      runat="server" 
					                      DataKeyNames="id_rec" 
					                      DataSourceID="SqlDataSourceResidenze"
					                      InsertItemPosition="LastItem" 
    						              
					                      OnItemInserting="ListViewResidenze_ItemInserting" 
					                      OnItemInserted="ListViewResidenze_ItemInserted"
					                      OnItemUpdating="ListViewResidenze_ItemUpdating" 
					                      OnItemUpdated="ListViewResidenze_ItemUpdated"
					                      OnItemDeleted="ListViewResidenze_ItemDeleted">
					            ...
					            <InsertItemTemplate>
						            <tr style="">
						                <td valign="top">
							                <asp:TextBox ID="indirizzo_residenzaTextBox" 
							                             runat="server" 
							                             Text='<%# Bind("indirizzo_residenza") %>'
							                             Width="99%" 
							                             MaxLength="100" />
							                <asp:RequiredFieldValidator ID="RequiredFieldValidatorAddress" 
							                                            runat="server" 
							                                            ControlToValidate="indirizzo_residenzaTextBox"
							                                            ErrorMessage="Campo obbligatorio." 
							                                            Display="Dynamic" 
						                ...
						                <td width="150" valign="top">
							                ...
							                <asp:TextBox ID="TextBoxComuneResidenza" 
							                             runat="server" 
							                             Text='<%# Eval("nome_comune") %>' />
							                <asp:RequiredFieldValidator ID="RequiredFieldValidatorComune" 
							                                            runat="server" 
							                                            ControlToValidate="TextBoxComuneResidenza"
							                                            ErrorMessage="Campo obbligatorio." 
							                                            Display="Dynamic" 
							                                            ValidationGroup="ResidenzeInsertGroup" >
							                </asp:RequiredFieldValidator>
							                ...
							                <div id="DivComuneResidenzaInsert"></div>
            								
							                <cc1:AutoCompleteExtender ID="AutoCompleteExtenderComuneResidenzaInsert" 
							                                          runat="server"
							                                          EnableCaching="True" 
							                                          TargetControlID="TextBoxComuneResidenza" 
							                                          ServicePath="~/ricerca_comuni.asmx"
							                                          ServiceMethod="RicercaComuni" 
							                                          MinimumPrefixLength="1" 
							                                          CompletionInterval="0"
							                                          CompletionSetCount="15" 
							                                          CompletionListElementID="DivComuneResidenzaInsert"
																	  OnClientItemSelected="autoCompleteComuneResidenzaSelected">
							                    <Animations>
								                <OnShow>
								                    <Sequence>
									                <OpacityAction Opacity='0' />
						                ...
						                <td width="100" valign="top">
							                <asp:TextBox ID="dt_residenza_Dal" 
							                             runat="server" 
							                             Width="70px" />
							                ...
							                <cc1:CalendarExtender ID="CalendarExtender2" 
							                                      runat="server" 
							                                      TargetControlID="dt_residenza_Dal"
							                                      PopupButtonID="Image1" 
							                                      Format="dd/MM/yyyy">
							                </cc1:CalendarExtender>
							                
							                <asp:RequiredFieldValidator ID="RequiredFieldValidatorResidenzaSince" 
							                                            runat="server"
							                                            ControlToValidate="dt_residenza_Dal" 
							                                            ErrorMessage="Campo obbligatorio." 
							                                            Display="Dynamic"
							                                            ValidationGroup="ResidenzeInsertGroup" >
							                </asp:RequiredFieldValidator>
							                
							                <asp:RegularExpressionValidator ID="RegularExpressionValidator_dt_residenza" 
							                                                ControlToValidate="dt_residenza_Dal"
							                                                runat="server" 
							                                                ErrorMessage="Ammessi solo valori GG/MM/AAAA." 
							                                                Display="Dynamic"
						                ...
						                <td width="100" valign="top">
							                <asp:TextBox ID="dt_residenza_Al" 
							                             runat="server" 								                         
							                             Width="70px" />
							                ...
							                <cc1:CalendarExtender ID="CalendarExtender1" 
							                                      runat="server" 
							                                      TargetControlID="dt_residenza_Al"
							                                      PopupButtonID="Image2" 
							                                      Format="dd/MM/yyyy">
							                </cc1:CalendarExtender>
							                <asp:RegularExpressionValidator ID="RequiredFieldValidatorResidenzaTo" 
							                                                ControlToValidate="dt_residenza_Al"
							                                                runat="server" 
							                                                ErrorMessage="Ammessi solo valori GG/MM/AAAA." 
							                                                Display="Dynamic"
							                                                ValidationExpression="(((0[1-9]|[12][0-9]|3[01])([/])(0[13578]|10|12)([/])(\d{4}))|(([0][1-9]|[12][0-9]|30)([/])(0[469]|11)([/])(\d{4}))|((0[1-9]|1[0-9]|2[0-8])([/])(02)([/])(\d{4}))|((29)(\.|-|\/)(02)([/])([02468][048]00))|((29)([/])(02)([/])([13579][26]00))|((29)([/])(02)([/])([0-9][0-9][0][48]))|((29)([/])(02)([/])([0-9][0-9][2468][048]))|((29)([/])(02)([/])([0-9][0-9][13579][26])))"
						                ...
						                <td width="50" valign="top">
							                <asp:TextBox ID="capTextBox" 
							                             runat="server" 
							                             Text='<%# Bind("cap") %>' 
							                             Width="50px"
							                             MaxLength="5" />
							                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidatorCAP" 
							                                            runat="server" 
							                                            ControlToValidate="capTextBox"
							                                            ErrorMessage="Campo obbligatorio." 
							                                            Display="Dynamic" 
							                                            ValidationGroup="ResidenzeInsertGroup" >
							                </asp:RequiredFieldValidator>--%>
							                <asp:RegularExpressionValidator ID="RegularExpressionValidatorCAP" 
							                                                ControlToValidate="capTextBox"
							                                                runat="server" 
							                                                Display="Dynamic" 
							                                                ErrorMessage="Formato non valido." 
					            ...
					            <EditItemTemplate>
						            <tr style="">
						                ...
						                <td valign="top">
							                ...
							                <div id="DivComuneResidenzaEdit"></div>
    								        
							                <cc1:AutoCompleteExtender ID="AutoCompleteExtenderComuneResidenzaEdit" 
							                                          runat="server"
							                                          EnableCaching="True" 
							                                          TargetControlID="TextBoxComuneResidenza" 
							                                          ServicePath="~/ricerca_comuni.asmx"
							                                          ...
							                                          CompletionInterval="0"
							                                          CompletionSetCount="15" 
							                                          CompletionListElementID="DivComuneResidenzaEdit"
																	  OnClientItemSelected="autoCompleteComuneResidenzaSelected">
							                    <Animations>
								                <OnShow>
								                    <Sequence>
						                ...
						                <td valign="top">
							                <asp:TextBox ID="dt_residenzaMod_Dal" 
							                             runat="server" 
							                             text='<%# Eval("data_da", "{0:dd/MM/yyyy}") %>'
							                             Width="70px" 
							                             MaxLength="10" />
							                ...
							                <cc1:CalendarExtender ID="CalendarExtender2" 
							                                      runat="server" 
							                                      TargetControlID="dt_residenzaMod_Dal"
							                                      PopupButtonID="Image3" 
							                                      Format="dd/MM/yyyy">
							                </cc1:CalendarExtender>
							                <asp:RequiredFieldValidator ID="RequiredFieldValidatorDtResidenzaSince" 
							                                            runat="server"
							                                            ControlToValidate="dt_residenzaMod_Dal" 
							                                            ErrorMessage="Campo obbligatorio." 
							                                            Display="Dynamic"
							                                            ValidationGroup="ResidenzeEditGroup" >
							                </asp:RequiredFieldValidator>
							                <asp:RegularExpressionValidator ID="RegularExpressionDtResidenzaSince" 
							                                                ControlToValidate="dt_residenzaMod_Dal"
							                                                runat="server" 
							                                                ErrorMessage="Ammessi solo valori GG/MM/AAAA." 
							                                                Display="Dynamic"
						                ...
						                <td valign="top">
							                <asp:TextBox ID="data_aTextBox" 
							                             runat="server" 
							                             text='<%# Eval("data_a", "{0:dd/MM/yyyy}") %>'
							                             Width="70px" 
							                             MaxLength="10" />
							                ...
							                <cc1:CalendarExtender ID="CalendarExtender3" 
							                                      runat="server" 
							                                      TargetControlID="data_aTextBox"
							                                      PopupButtonID="Image4" 
							                                      Format="dd/MM/yyyy">
							                </cc1:CalendarExtender>
							                <asp:RegularExpressionValidator ID="RegularExpressionDtResidenzaTo" 
							                                                ControlToValidate="data_aTextBox"
							                                                runat="server" 
							                                                ErrorMessage="Ammessi solo valori GG/MM/AAAA." 
							                                                Display="Dynamic"
							                                                ValidationExpression="(((0[1-9]|[12][0-9]|3[01])([/])(0[13578]|10|12)([/])(\d{4}))|(([0][1-9]|[12][0-9]|30)([/])(0[469]|11)([/])(\d{4}))|((0[1-9]|1[0-9]|2[0-8])([/])(02)([/])(\d{4}))|((29)(\.|-|\/)(02)([/])([02468][048]00))|((29)([/])(02)([/])([13579][26]00))|((29)([/])(02)([/])([0-9][0-9][0][48]))|((29)([/])(02)([/])([0-9][0-9][2468][048]))|((29)([/])(02)([/])([0-9][0-9][13579][26])))"
					            ...
					            <ItemTemplate>
						            <tr style="">
						                <td>
							                <asp:Label ID="indirizzo_residenzaLabel" 
							                           runat="server" 
							                           Text='<%# Eval("indirizzo_residenza") %>' />
						                </td>
        							    
						                <td>
							                <asp:Label ID="id_comune_residenzaLabel" 
							                           runat="server" 
							                           Text='<%# Eval("nome_comune") %>' />
						                </td>
        							    
						                <td>
							                <asp:Label ID="data_daLabel" 
							                           runat="server" 
							                           Text='<%# Eval("data_da", "{0:dd/MM/yyyy}") %>' />
						                </td>
        							    
						                <td>
							                <asp:Label ID="data_aLabel" 
							                           runat="server" 
							                           Text='<%# Eval("data_a", "{0:dd/MM/yyyy}") %>' />
						                </td>
        							    
						                <td>
							                <asp:Label ID="capLabel" 
							                           runat="server" 
							                           Text='<%# Eval("cap") %>' />
						                </td>
				        ...
				        <cc1:ModalPopupExtender ID="ModalPopupExtenderResidenze" BehaviorID="ModalPopup1" runat="server" PopupControlID="PanelResidenze"
				            BackgroundCssClass="modalBackground" DropShadow="true" TargetControlID="ButtonResidenze"
				            CancelControlID="ButtonChiudiResidenze" />
			        </asp:Panel>
				    ...
				    <asp:UpdatePanel ID="UpdatePanelRecapiti" runat="server">
					    ...
					    <asp:ListView ID="ListViewRecapiti" runat="server" DataKeyNames="id_rec" DataSourceID="SqlDataSourceRecapiti"
					        InsertItemPosition="LastItem" OnItemInserting="ListViewRecapiti_ItemInserting" OnItemInserted="ListViewRecapiti_ItemInserted"
					        OnItemUpdating="ListViewRecapiti_ItemUpdating" OnItemDeleted="ListViewRecapiti_ItemDeleted" OnItemUpdated="ListViewRecapiti_ItemUpdated">
					        <LayoutTemplate>
					    ...
					    <asp:SqlDataSource ID="SqlDataSourceRecapiti" runat="server" ConnectionString="<%$ ConnectionStrings:GestioneConsiglieriConnectionString %>"
					        DeleteCommand="DELETE FROM join_persona_recapiti 
					                       WHERE id_rec = @id_rec"
					        
					        InsertCommand="INSERT INTO join_persona_recapiti (id_persona, recapito, tipo_recapito) 
					                       VALUES (@id_persona, @recapito, @tipo_recapito); 
					                       SELECT @id_rec = SCOPE_IDENTITY();"
				    ...
				    <cc1:ModalPopupExtender ID="ModalPopupExtenderRecapiti" BehaviorID="ModalPopup2" runat="server" PopupControlID="PanelRecapiti"
				        BackgroundCssClass="modalBackground" DropShadow="true" TargetControlID="ButtonRecapiti"
				        CancelControlID="ButtonChiudiRecapiti" />
			        </asp:Panel>
				    ...
				    <asp:UpdatePanel ID="UpdatePanelTitoliStudio" runat="server">
					    ...
					    <asp:ListView ID="ListViewTitoliStudio" runat="server" DataKeyNames="id_rec" DataSourceID="SqlDataSourceTitoliStudio"
					        InsertItemPosition="LastItem" OnItemInserting="ListViewTitoliStudio_ItemInserting" OnItemInserted="ListViewTitoliStudio_ItemInserted"
					        OnItemUpdating="ListViewTitoliStudio_ItemUpdating" OnItemDeleted="ListViewTitoliStudio_ItemDeleted" OnItemUpdated="ListViewTitoliStudio_ItemUpdated">
					        <LayoutTemplate>
						    ...
						    <tr style="">
							    ...
							    <asp:DropDownList ID="DropDownListAnniEdit" runat="server" SelectedValue='<%# Bind("anno_conseguimento") %>'
							        DataSourceID="SqlDataSourceAnni" DataTextField="anno" DataValueField="anno" Width="150px" AppendDataBoundItems="true">
							        <asp:ListItem Text="(non specificato)" Value="" />
							    </asp:DropDownList>
						        </td>
						        <td>
					    ...
					    <asp:SqlDataSource ID="SqlDataSourceAnni" 
					                       ...
					                       SelectCommand="SELECT anno 
					                                      FROM tbl_anni
					                                      WHERE (anno &gt; YEAR(GETDATE()) - 50) 
					                                        AND (anno &lt;= YEAR(GETDATE())) 
					                                      ORDER BY anno DESC" >
					    </asp:SqlDataSource>
					    <asp:SqlDataSource ID="SqlDataSourceTitoli" runat="server" ConnectionString="<%$ ConnectionStrings:GestioneConsiglieriConnectionString %>"
					        SelectCommand="SELECT * 
				    ...
				    <cc1:ModalPopupExtender ID="ModalPopupExtenderTitoliStudio" BehaviorID="ModalPopup3" runat="server" PopupControlID="PanelTitoliStudio"
				        BackgroundCssClass="modalBackground" DropShadow="true" TargetControlID="ButtonTitoliStudio"
				        CancelControlID="ButtonChiudiTitoliStudio" />
			        </asp:Panel>
			        <%
				    }
			        %>
