<%@ Page Language="C#" 
         ...
         CodeFile="gestisciLegislature.aspx.cs" 
         Inherits="legislature_gestisciLegislature"
         Title="Legislature > Ricerca" %>
	...
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		...
		<asp:GridView ID="GridView1" 
		    ...
		    <Columns>
			    ...
			    <asp:BoundField DataField="durata_legislatura_da" 
			                    HeaderText="Dal" 
			    ...
			    <asp:BoundField DataField="durata_legislatura_a" 
			                    HeaderText="Al" 
			                    SortExpression="durata_legislatura_a"
			                    DataFormatString="{0:dd/MM/yyyy}" 
			                    ItemStyle-HorizontalAlign="center" 
			                    ItemStyle-Width="80px" />
			    ...
			    <asp:TemplateField>
			        ...
			        <ItemTemplate>
				        <asp:HyperLink ID="HyperLinkDettagli" 
				                       runat="server"
				                       NavigateUrl='<%# Eval("id_legislatura", "dettaglio.aspx?mode=normal&id={0}") %>'
				                       Text="Dettagli">
				        </asp:HyperLink>
			        </ItemTemplate>
