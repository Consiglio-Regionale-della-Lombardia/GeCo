<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pratiche.aspx.cs" Inherits="pratiche_pratiche" Title="Persona > Pratiche" %>
    ...
    <table style="width: 98%" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td>
                <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSourceHead" Width="50%">
                    <ItemTemplate>
                        <table>
                            <tr>
                                <td width="50">
                                    <img alt="" src="<%= photoName %>" width="50" height="50" style="border: 1px solid #99cc99;
                                        margin-right: 10px;" align="middle" />
                                </td>
                                <td>
                                    <span style="font-size: 1.5em; font-weight: bold; color: #50B306;">
                                        <asp:Label ID="LabelHeadNome" runat="server" Text='<%# Eval("nome_completo") %>'>
                                        </asp:Label>
                                    </span>
                                    <br />
                                    <asp:Label ID="LabelHeadDataNascita" runat="server" Text='<%# Eval("data_nascita", "{0:dd/MM/yyyy}") %>'>
                                    </asp:Label>
                                    <asp:Label ID="LabelHeadGruppo" runat="server" Font-Bold="true" Text='<%# Eval("nome_gruppo") %>'>
                                    </asp:Label>
                                </td>
                            </tr>
                        </table>
                ...
                <asp:SqlDataSource ID="SqlDataSourceHead" runat="server" ConnectionString="<%$ ConnectionStrings:GestioneConsiglieriConnectionString %>"
                            ...
                            <ContentTemplate>
                                <table>
                                    <tr>
                                        ...
                                        <td valign="top" width="230">
                                            Seleziona data:
                                            <asp:TextBox ID="TextBoxFiltroData" runat="server" Width="70px">
                                            </asp:TextBox>
                                ...
                                <br />
                                <br />
                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" PagerStyle-HorizontalAlign="Center"
                                    AllowSorting="True" AutoGenerateColumns="False" CellPadding="5" CssClass="tab_gen"
                                    DataSourceID="SqlDataSource1" GridLines="None" DataKeyNames="id_rec" OnPageIndexChanging="GridView1_PageIndexChanging">
                                    <EmptyDataTemplate>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="numero_pratica" HeaderText="Numero Pratica" SortExpression="numero_pratica"
                                            ItemStyle-HorizontalAlign="center" ItemStyle-Width="100px" />
                                        <asp:BoundField DataField="data" HeaderText="Data Pratica" SortExpression="data"
                        ...
                        <asp:Panel ID="PanelDetails" runat="server" BackColor="White" BorderColor="DarkSeaGreen"
                            ...
                            <div align="center">
                                ...
                                <asp:UpdatePanel ID="UpdatePanelDetails" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" CssClass="tab_det"
                                            Width="420px" DataSourceID="SqlDataSource2" OnModeChanged="DetailsView1_ModeChanged"
                                            ...
                                            OnItemDeleted="DetailsView1_ItemDeleted" DataKeyNames="id_rec">
                                            ...
                                            <Fields>
                                                ...
                                                <asp:TemplateField HeaderText="Numero Pratica" SortExpression="oggetto">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblNum_Pratica" runat="server" Text='<%# Bind("numero_pratica") %>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="txtNumPratica_Edit" runat="server" Text='<%# Bind("numero_pratica") %>'
                                                            MaxLength='50'>
                                                        </asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorNumPratica_Edit" ControlToValidate="txtNumPratica_Edit"
                                                            runat="server" Display="Dynamic" ErrorMessage="Campo obbligatorio." ValidationGroup="ValidGroup" />
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <asp:TextBox ID="txtNumPratica_Insert" runat="server" Text='<%# Bind("numero_pratica") %>'
                                                            MaxLength='50'>
                                                        </asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorNumPratica_Insert" ControlToValidate="txtNumPratica_Insert"
                                                            runat="server" Display="Dynamic" ErrorMessage="Campo obbligatorio." ValidationGroup="ValidGroup" />
                                                    </InsertItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Data Pratica" SortExpression="data">
                                                    <ItemTemplate>
                                                        <asp:Label ID="LabelDataPratica" runat="server" Text='<%# Eval("data", "{0:dd/MM/yyyy}") %>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="dt_pratica_mod" runat="server" Text='<%# Eval("data", "{0:dd/MM/yyyy}") %>'></asp:TextBox>
                                                ...
                                                <asp:TemplateField HeaderText="Oggetto" SortExpression="oggetto">
                                                    ...
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="TextBoxOggetto" runat="server" Text='<%# Bind("oggetto") %>' MaxLength='50'>
                                                        </asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorOggetto" ControlToValidate="TextBoxOggetto"
                                                            runat="server" Display="Dynamic" ErrorMessage="Campo obbligatorio." ValidationGroup="ValidGroup" />
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <asp:TextBox ID="TextBoxOggetto" runat="server" Text='<%# Bind("oggetto") %>' MaxLength='50'>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:GestioneConsiglieriConnectionString %>"
                                            DeleteCommand="UPDATE join_persona_pratiche 
				                                  SET deleted = 1 
				                                  WHERE id_rec = @id_rec" InsertCommand="INSERT INTO join_persona_pratiche (id_legislatura, 
				                                                                     id_persona,
				                                                                     numero_pratica, 
				                                                                     data, 
				                                                                     oggetto, 
				                                  ...
				                                  VALUES (@id_legislatura, 
				                                          ...
				                                          @oggetto, 
				                                          @note); 
				                                  SELECT @id_rec = SCOPE_IDENTITY();" SelectCommand="SELECT * 
				                                  FROM join_persona_pratiche AS jj 
				                                  INNER JOIN legislature AS ll 
				                                    ON jj.id_legislatura = ll.id_legislatura
				                                  WHERE id_rec = @id_rec" UpdateCommand="UPDATE join_persona_pratiche 
				                                  SET id_legislatura = @id_legislatura, 
				                                      ...
				                                      oggetto = @oggetto, 
				                                      note = @note 
				                                  WHERE id_rec = @id_rec" OnInserted="SqlDataSource2_Inserted">
                                            <SelectParameters>
        ...
        <tr>
            <td align="right">
                <b><a id="a_back" runat="server" href="../persona/persona.aspx">« Indietro </a></b>
            </td>
        </tr>
        <tr>
            <td>
