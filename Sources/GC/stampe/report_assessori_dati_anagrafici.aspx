<%@ Page Language="C#" 
         ...
         CodeFile="report_assessori_dati_anagrafici.aspx.cs" 
         Inherits="report_assessori_dati_anagrafici" 
         Title="STAMPE > Assessori (Dati Anagrafici) " %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
<div id="content">
    <asp:Label ID="lblTitle" 
               runat="server"
               Text="Report Assessori (Dati Anagrafici)"
               Font-Bold="true" >
    </asp:Label>   
