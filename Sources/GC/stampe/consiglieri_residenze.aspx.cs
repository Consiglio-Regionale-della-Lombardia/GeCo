...
using System.Web.UI;
/// <summary>
/// Classe per la gestione Stampa Consiglieri Residenza
/// </summary>

public partial class stampe_consiglieri_residenze : System.Web.UI.Page
{
    int id_user;
    string title = "Elenco Consiglieri-Residenze";
    string tab = "Stampe Consiglieri-Residenze";
    string filename = "Elenco_Consiglieri_Residenze";
    ...
    protected override void Render(HtmlTextWriter writer)
    {
        if (formato.Length > 0)
        {
            string FileName = "Consiglieri-Residenze";
