<%@ Page Language="C#"          
         ...
         CodeFile="sedute_numero.aspx.cs" 
         Inherits="stampe_sedute_numero" 
         Title="Stampe > Numero Sedute" %>
...
<div id="content">
    ...
    <asp:GridView ID="GridView1" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="conto" 
                            HeaderText="Numero sedute" 
                            SortExpression="conto"
                            ItemStyle-VerticalAlign="Middle" 
                            ItemStyle-HorizontalAlign="Center" 
