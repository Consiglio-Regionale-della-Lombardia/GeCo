...
using System.Web.UI;
/// <summary>
/// Classe per la gestione Stampa Consiglieri non in Carica
/// </summary>

public partial class stampe_consiglieri_cariche_out : System.Web.UI.Page
{
    int id_user;
    string title = "Elenco Consiglieri non in carica-Cariche";
    string tab = "Stampe Consiglieri non in carica-Cariche";
    string filename = "Elenco_Consiglieri_OUT_Cariche";
