<%@ Page Language="C#" 
         ...
         CodeFile="consiglieri_cariche_out.aspx.cs" 
         Inherits="stampe_consiglieri_cariche_out" 
         Title="STAMPE > Consiglieri non in carica + Cariche" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
<div id="content">
	<b>Stampa di tutti i consiglieri non in carica più quelle ricoperte in passato.</b>
	<br />
	<br />
