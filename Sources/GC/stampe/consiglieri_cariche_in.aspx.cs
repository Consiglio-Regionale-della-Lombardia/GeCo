...
using System.Web.UI;
/// <summary>
/// Classe per la gestione Stampa Consiglieri in Carica
/// </summary>

public partial class stampe_consiglieri_cariche_in : System.Web.UI.Page
{
    int id_user;
    string title = "Elenco Consiglieri in carica-Cariche";
    string tab = "Stampe Consiglieri in carica-Cariche";
    string filename = "Elenco_Consiglieri_IN_Cariche";
