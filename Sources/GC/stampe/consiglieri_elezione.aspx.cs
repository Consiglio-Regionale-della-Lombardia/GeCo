...
using System.Web.UI;
/// <summary>
/// Classe per la gestione Stampa Consiglieri Elezione
/// </summary>

public partial class stampe_consiglieri_elezione : System.Web.UI.Page
{
    int id_user;
    string title = "Elenco Consiglieri-Dati Elezione";
    string tab = "Stampe Consiglieri-Dati Elezione";
    string filename = "Elenco_Consiglieri_Dati_Elezione";
    ...
    protected override void Render(HtmlTextWriter writer)
    {
        if (formato.Length > 0)
        {
            string FileName = "Consiglieri-DatiElezione";
