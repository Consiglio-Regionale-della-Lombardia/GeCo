<%@ Page Language="C#" 
         ...
         CodeFile="report_segrcons_presenze_sedute.aspx.cs" 
         Inherits="report_segrcons_presenze_sedute" 
         Title="STAMPE > Report Presenze Sedute" %>
...
<div id="content">
    ...
    <div id="content_filtri_vis" class="pannello_ricerca">
        ...
        <tr align="left">
            ...
            <td align="left">
                <asp:Label ID="lbl_stato"
                           runat="server"
                           Text="Stato: "
                           Width="60px" >
                </asp:Label>
                
                <asp:DropDownList ID="ddl_stato"
                                  runat="server"
                                  AppendDataBoundItems="true"
                                  DataSourceID="SQLDataSource_stato"
                                  DataTextField="nome_partecipazione" 
                                  DataValueField="id_partecipazione" >
                    <asp:ListItem Text="(tutte)" Value=""></asp:ListItem>
                </asp:DropDownList>
                
                <asp:SqlDataSource ID="SQLDataSource_stato"
                                   runat="server"
                                   ConnectionString="<%$ ConnectionStrings:GestioneConsiglieriConnectionString %>"
                                  
                                   SelectCommand="SELECT id_partecipazione,
                                                         nome_partecipazione
                                                  FROM tbl_partecipazioni
                                                  ORDER BY grado" >
                </asp:SqlDataSource>
	...
	<div align="center">
	    <asp:GridView ID="GridView1" 
		    ...
		    <Columns>
		        <asp:BoundField DataField="Data seduta" 
			                    SortExpression="Data seduta"
			                    ShowHeader="false" 
