...
using System.Web.UI;
/// <summary>
/// Classe per la gestione Stampa Consiglieri Recapiti
/// </summary>

public partial class stampe_consiglieri_recapiti : System.Web.UI.Page
{
    int id_user;
    string title = "Elenco Consiglieri-Recapiti";
    string tab = "Stampe Consiglieri-Recapiti";
    string filename = "Elenco_Consiglieri_Recapiti";
    ...
    protected override void Render(HtmlTextWriter writer)
    {
        if (formato.Length > 0)
        {
            string FileName = "Consiglieri-Recapiti";
