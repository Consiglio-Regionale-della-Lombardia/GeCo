...
using System.Web.UI;
/// <summary>
/// Classe per la gestione Stampa Gruppi Consiglieri
/// </summary>

public partial class stampe_consiglieri_gruppi : System.Web.UI.Page
{
    int id_user;
    string title = "Elenco Consiglieri-Gruppi";
    string tab = "Stampe Consiglieri-Gruppi";
    string filename = "Elenco_Consiglieri_Gruppi";
    ...
    protected override void Render(HtmlTextWriter writer)
    {
        if (formato.Length > 0)
        {
            string FileName = "Consiglieri-GruppiPolitici";
