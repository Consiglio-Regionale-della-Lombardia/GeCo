...
using System.Web.UI;
/// <summary>
/// Classe per la gestione Stampa Consiglieri Sospesi
/// </summary>

public partial class stampe_consiglieri_sospesi : System.Web.UI.Page
{
    int id_user;
    string title = "Elenco Consiglieri Sospesi";
    string tab = "Stampe Consiglieri-Sospesi";
    string filename = "Elenco_Consiglieri_Sospesi";
