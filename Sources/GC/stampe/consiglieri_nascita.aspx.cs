...
using System.Web.UI;
/// <summary>
/// Classe per la gestione Stampa Consiglieri Nascita
/// </summary>

public partial class stampe_consiglieri_nascita : System.Web.UI.Page
{
    int id_user;
    string title = "Elenco Consiglieri-Dati Nascita";
    string tab = "Stampe Consiglieri-Dati Nascita";
    string filename = "Elenco_Consiglieri_Dati_Nascita";
    ...
    protected override void Render(HtmlTextWriter writer)
    {
        if (formato.Length > 0)
        {
            string FileName = "Consiglieri-DatiNascita";
