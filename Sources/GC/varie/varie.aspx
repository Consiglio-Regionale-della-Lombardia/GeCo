<%@ Page Language="C#" 
         ...
         CodeFile="varie.aspx.cs" 
         Inherits="varie_varie" 
         Title="Persona > Varie" %>
		            ...
		            <ContentTemplate>
			            <asp:ListView ID="ListView1" 
			                ...
			                <InsertItemTemplate>
				                ...
				                <tr style="">
				                    <td valign="top">
					                <asp:TextBox ID="TextBoxNote" runat="server" Text='<%# Bind("note") %>' Width="99%" />
					                <asp:RequiredFieldValidator ID="RequiredFieldValidatorNote" 
					                runat="server" 
					                ErrorMessage="Campo obbligatorio."
					                    ControlToValidate="TextBoxNote" Display="Dynamic" 
					                ...
					                <asp:Button ID="InsertButton" runat="server" CommandName="Insert" Text="Inserisci"
					                    CssClass="button" ValidationGroup="ValidGroupInsert" />
			                ...
			                <EditItemTemplate>
				                <tr style="">
					                ...
					                <asp:Button ID="UpdateButton" runat="server" CommandName="Update" Text="Aggiorna"
					                    CssClass="button" ValidationGroup="ValidGroupEdit" />
