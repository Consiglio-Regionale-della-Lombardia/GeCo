...
/// <summary>
/// Classe per la gestione Presenze
/// </summary>

public partial class presenze_presenze : System.Web.UI.Page
{
    string id;
    string sel_leg_id;
    ...
    string tab = "Consiglieri - Presenze/Assenze";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack == false)
        {
            ...
            if (role < 3)
            {
                query = query.Replace("AND jj.copia_commissioni = 0", "AND jj.copia_commissioni = 2");
            }
            else if (role == 4)
            {
                query = query.Replace("AND jj.copia_commissioni = 0", "AND jj.copia_commissioni = 1");
    ...
    protected void EseguiRicerca()
    {
        ...
        {
            if (!nome_organo.Contains("ufficio di presidenza"))
