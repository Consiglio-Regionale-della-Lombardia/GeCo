...
/// <summary>
/// Classe per la gestione Sostituzioni
/// </summary>

public partial class sostituzioni_sostituzioni : System.Web.UI.Page
{
    string id;
    string sel_leg_id;
    ...
    string title = "Elenco Sostituzioni, ";
    string tab = "Consiglieri - Sostituzioni";
    string filename = "Elenco_Sostituzioni_";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        id = Convert.ToString(Session.Contents["id_persona"]);
        sel_leg_id = Convert.ToString(Session.Contents["sel_leg_id"]);

        photoName = Convert.ToString(Session.Contents["foto_persona"]);
        ...
        tabsPersona.SelectTab(EnumTabsPersona.a_sostituzioni);
    }
    /// <summary>
    ...
    protected void DetailsView1_ItemInserting(object sender, DetailsViewInsertEventArgs e)
    {
        ...
        e.Values["tipo"] = "Sostituisce";

        HiddenField TextBoxSostitutoId = DetailsView1.FindControl("TextBoxSostitutoId") as HiddenField;
        if (id == TextBoxSostitutoId.Value)
        {
            e.Cancel = true;
            Session.Contents.Add("align", "center");
            Session.Contents.Add("error_message", "Impossibile sostituire se stessi!");
            Response.Redirect("../errore.aspx");
        }
        else
        {
            ...
            e.Values["sostituto"] = TextBoxSostitutoId.Value;
        }
        ...
        if (txtDataDeliberaInsert.Text.Length > 0)
    ...
    protected void DetailsView1_ItemUpdating(object sender, DetailsViewUpdateEventArgs e)
    {
        ...
        else
        {
            ...
            e.Keys["sostituto"] = TextBoxSostitutoId.Value;
        }
        ...
        if (txtDataDeliberaEdit.Text.Length > 0)
    ...
    {
        Audit.LogUpdate(Convert.ToInt32(Session.Contents["user_id"]), Convert.ToInt32(e.Keys[0]), "join_persona_sostituzioni");
    ...
    {
        Audit.LogDelete(Convert.ToInt32(Session.Contents["user_id"]), Convert.ToInt32(e.Keys[0]), "join_persona_sostituzioni");
    ...
    protected void EseguiRicerca()
    {
        ...
        {
            query += " AND ('" + TextBoxFiltroData.Text + "' = jj.data_sostituzione OR jj.data_sostituzione IS NULL)";
        }
        query += " ORDER BY jj.data_inizio DESC";
    ...
    protected void SqlDataSource2_Inserted(object sender, SqlDataSourceStatusEventArgs e)
    {
        if (e.Exception == null)
        {
            Audit.LogInsert(Convert.ToInt32(Session.Contents["user_id"]), Convert.ToInt32(e.Command.Parameters["@id_rec"].Value), "join_persona_sostituzioni");
        }
    ...
    /// <summary>
    /// Metodo per generazione URL dopo il POstBack
    /// </summary>
    /// <returns>Stringa URL della Form</returns>

    public string GetPostBackURL()
    {
        string url = "~/sostituzioni/sostituzioni.aspx" +
                     "?mode=normal" +
                     "&id=" + id +
                     "&sel_leg_id=" + sel_leg_id;
