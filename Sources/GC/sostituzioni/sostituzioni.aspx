<%@ Page Language="C#" 
         ...
         CodeFile="sostituzioni.aspx.cs" 
         Inherits="sostituzioni_sostituzioni" 
         Title="Persona > Sostituzioni" %>
			...
			<asp:UpdatePanel ID="UpdatePanelMaster" runat="server" UpdateMode="Conditional">
				...
				<asp:GridView ID="GridView1" 
				    ...
				    <Columns>
					    ...
					    <asp:TemplateField  HeaderText="Sostituto/Sostituente" SortExpression="nome_completo">       
					        <ItemTemplate> 
				...
				<ContentTemplate>
					...
					<Fields>
					    <asp:TemplateField HeaderText="Legislatura">
						    ...
						    <EditItemTemplate>
						        <asp:DropDownList ID="DropDownListLeg" 
						                          runat="server" DataSourceID="SqlDataSourceLeg"
						...
						<ItemTemplate>
						    <asp:Label ID="LabelTipo" runat="server" Text='<%# Bind("tipo") %>'></asp:Label>
						</ItemTemplate>
						<EditItemTemplate>
						    <asp:RadioButtonList runat="Server" ID="RadioButtonListTipo" SelectedValue='<%# Bind("tipo") %>'>
							<asp:ListItem Value="Sostituito" Text="Sostituito" />
							<asp:ListItem Value="Sostituisce" Text="Sostituisce" />
						    </asp:RadioButtonList>
						</EditItemTemplate>
						<InsertItemTemplate>
						    <asp:RadioButtonList runat="Server" ID="RadioButtonListTipo" SelectedValue='<%# Bind("tipo") %>'>
							<asp:ListItem Value="Sostituito" Text="Sostituito" Selected="True" />
							<asp:ListItem Value="Sostituisce" Text="Sostituisce" />
						    </asp:RadioButtonList>
						</InsertItemTemplate>
					    </asp:TemplateField>--%>
					    ...
					    <asp:TemplateField HeaderText="Numero Delibera" SortExpression="numero_delibera">
						    ...
						    <EditItemTemplate>
						        <asp:TextBox ID="TextBoxNumeroDelibera" runat="server" Text='<%# Bind("numero_delibera") %>'></asp:TextBox>
						        <asp:RegularExpressionValidator ID="RegularExpressionValidatorNumeroDelibera" ControlToValidate="TextBoxNumeroDelibera"
					    ...
					    <asp:TemplateField HeaderText="Data Delibera" SortExpression="data_delibera">
						    ...
						    <InsertItemTemplate>
						        ...
						        <img alt="calendar" src="../img/calendar_month.png" id="ImageDataDeliberaInsert"
							    runat="server" />
					    ...
					    <asp:TemplateField HeaderText="Protocollo Delibera" SortExpression="protocollo_delibera">
						    <ItemTemplate>
						        <asp:Label ID="LabelProtocolloDelibera" runat="server" Text='<%# Bind("protocollo_delibera") %>'></asp:Label>
						    </ItemTemplate>
						    
						    <EditItemTemplate>
						        <asp:TextBox ID="TextBoxProtocolloDelibera" runat="server" Text='<%# Bind("protocollo_delibera") %>'></asp:TextBox>
						        <asp:RegularExpressionValidator ID="RegularExpressionValidatorProtocolloDelibera"
							    ControlToValidate="TextBoxProtocolloDelibera" runat="server" Display="Dynamic"
							    ErrorMessage="Solo cifre ammesse." ValidationExpression="^[0-9]+$" ValidationGroup="ValidGroup" />
						    </EditItemTemplate>
					    ...
					    <asp:TemplateField SortExpression="tipo">
					        <HeaderTemplate>					            				            				            
					            <asp:Label ID="header_sost2"
					                       runat="server"					                       
					                       Text='<%# DataBinder.Eval(Container.DataItem, "tipo")==null?"Sostituisce":DataBinder.Eval(Container.DataItem, "tipo").ToString()%>'>				            
					            </asp:Label>
					        </HeaderTemplate>
						    ...
						    <InsertItemTemplate>
						        ...
						        <asp:RequiredFieldValidator ID="RequiredFieldValidatorSostitutoInsert" 
						                                    ControlToValidate="TextBoxSostituto"
							                                runat="server" 
							                                Display="Dynamic" 
							                                ErrorMessage="Campo obbligatorio." 
							                                ValidationGroup="ValidGroup" />
						    ...
						    <EditItemTemplate>
								<asp:HiddenField ID="TextBoxSostitutoId" runat="server" Value='<%# Bind("sostituto") %>'></asp:HiddenField>

						        <asp:TextBox ID="TextBoxSostituto" 
						                     runat="server" 
						                     Text='<%# Bind("nome_completo") %>'>
						        </asp:TextBox>
						        <asp:RequiredFieldValidator ID="RequiredFieldValidatorSostitutoEdit" 
						                                    ControlToValidate="TextBoxSostituto"
							                                runat="server" 
							                                Display="Dynamic" 
							                                ErrorMessage="Campo obbligatorio." 
					    ...
					    <asp:TemplateField HeaderText="Inizio sostituzione" SortExpression="data_inizio">
						    <ItemTemplate>
						    ...
						    <EditItemTemplate>
						        ...
						        <asp:RequiredFieldValidator ID="RequiredFieldValidatorDataInizioEdit" 
						    ...
						    <InsertItemTemplate>
						        ...
						        <asp:RequiredFieldValidator ID="RequiredFieldValidatorDataInizioInsert" 
					    ...
					    <asp:TemplateField HeaderText="Fine sostituzione" SortExpression="data_fine">
						    <ItemTemplate>
						...
						<ItemTemplate>
						    <asp:Label ID="label_descrizione_causa" runat="server" Text='<%# Eval("descrizione_causa") %>'>
						    </asp:Label>
						</ItemTemplate>
				    ...
				    <asp:SqlDataSource ID="SqlDataSource2" 
					                   ...
					                   DeleteCommand="UPDATE [join_persona_sostituzioni] 
					                                  SET [deleted] = 1 
					                                  WHERE [id_rec] = @id_rec"
					                   
					                   InsertCommand="INSERT INTO [join_persona_sostituzioni] ([id_legislatura], 
					                                                                           [id_persona], 
					                                                                           [tipo], 
					                                                                           [numero_delibera], 
					                                                                           [data_delibera], 
					                   ...
					                   UpdateCommand="UPDATE [join_persona_sostituzioni] 
					                                  SET [id_legislatura] = @id_legislatura, 
					                                      ...
					                                      [protocollo_delibera] = @protocollo_delibera, 
					                                      [sostituto] = @sostituto, 
					...
					<UpdateParameters>
					    ...
					    <asp:Parameter Name="protocollo_delibera" Type="String" />
					    <asp:Parameter Name="sostituto" Type="Int32" />
				    ...
				    <asp:SqlDataSource ID="SqlDataSource3" 
				                       runat="server" 
				                       ConnectionString="<%$ ConnectionStrings:GestioneConsiglieriConnectionString %>"
					                   SelectCommand="SELECT descrizione_causa, MAX(id_causa) as id_causa
                                                        FROM [tbl_cause_fine] 
