...
/// <summary>
/// Classe per la gestione Legislature dei gruppi politici
/// </summary>
public partial class gruppi_politici_legislature : System.Web.UI.Page
{
    string id;
    public int role;
    ...
    string tab = "Gruppi Politici - Legislature";
    string filename = "Elenco_Legislature_";
    bool no_last_col = true;
    bool no_first_col = false;
    bool landscape = false;


    string query_group_name = @"SELECT nome_gruppo 
    ...
    protected void DetailsView1_ItemInserting(object sender, DetailsViewInsertEventArgs e)
    {
        ...
        // campo obbligatorio
        TextBox txtInizio = DetailsView1.FindControl("dtIns_inizio") as TextBox;
        e.Values["data_inizio"] = Utility.ConvertStringToDateTime(txtInizio.Text, "0", "0", "0");

        TextBox txtFine = DetailsView1.FindControl("dtIns_fine") as TextBox;
        if (txtFine.Text.Length > 0)
            e.Values["data_fine"] = Utility.ConvertStringToDateTime(txtFine.Text, "0", "0", "0");
        else
    ...
    protected void DetailsView1_ItemUpdating(object sender, DetailsViewUpdateEventArgs e)
    {
        ...
        // campo obbligatorio
        TextBox txtInizio = DetailsView1.FindControl("dtMod_inizio") as TextBox;
        e.Keys["data_inizio"] = Utility.ConvertStringToDateTime(txtInizio.Text, "0", "0", "0");

        TextBox txtFine = DetailsView1.FindControl("dtMod_fine") as TextBox;
        if (txtFine.Text.Length > 0)
            e.Keys["data_fine"] = Utility.ConvertStringToDateTime(txtFine.Text, "0", "0", "0");
        else
    ...
    protected void LinkButtonDettagli_Click(object sender, EventArgs e)
    {
        ...
        SqlDataSource3.SelectParameters.Add("id_rec", Convert.ToString(GridView1.DataKeys[row.RowIndex].Value));
